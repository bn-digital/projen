...
new HtmlProject(options: BndigitalProjectOptions)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@bn-digital/projen.HtmlProject.Initializer.parameter.options">options</a></code> | <code><a href="#@bn-digital/projen.BndigitalProjectOptions">BndigitalProjectOptions</a></code> | *No description.* |
