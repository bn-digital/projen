...
import { FileBase, JsonFile, Project } from "projen"
 ...
 */
export function synthSnapshot<T extends Project>(project: T, options: SnapshotOptions = {}): SynthOutput {
  ...
  try {
    ...
    return directorySnapshot(project.outdir, {
      ...
      supportJsonComments: project.files.some(
        ...
        (file: FileBase) => file instanceof JsonFile && file.supportsComments
      ),
    })
  } finally {
 ...
 */
function isCommentArrayWithoutComments(obj: CommentJSONValue): boolean {
  return obj instanceof CommentArray && Object.getOwnPropertySymbols(obj).length === 0
}